...
- **Stock-E2 interoperability (Gate A):** real E2 Setup plus KPM subscription/indication and a nonempty E2AP PCAP. Decode with tshark only when its installed dissector supports E2AP.
